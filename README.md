...
In this tutorial we will be doing some comfiguration activities with network security groups and observing network traffic between Azure Virtual Machines, Using Wireshark, gaining intuition on how different protocals such as ICMP, SSH, DHCP, DNS, and RDP work and how to use them.
